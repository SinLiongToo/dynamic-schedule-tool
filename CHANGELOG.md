...
- 標題下方新增版本號與更新日期時間（例如「版本 v1.3.1 · 更新於 2026-09-15 07:18 (UTC+8)」），「說明」(❓) 視窗底部也會顯示；之後每次修改都會手動更新這兩個值（見 SKILL.md）。
  Added a version number and last-updated date/time under the app title (e.g. "v1.3.1 · updated 2026-09-15 07:18 (UTC+8)"), also shown at the bottom of the Help (❓) dialog; both are bumped by hand on every future change (see SKILL.md).
